...
int main(void) {
  ...
  // PNG smthn;
  // smthn.readFromFile("output-images/1.png");
  // ImgList list1x2(smthn);
  // PNG outputimg = list1x2.Render(false, 0);
  // outputimg.writeToFile("output-images/1x2-0-0.png");
...
void TestConstructorRender() {
  ...
  if (inimg.height() == 4 && inimg.width() == 3) {
    ...
    int x = list3x4.GetDimensionX();
    cout << x << endl;

    x = list3x4.GetDimensionY(); 
    cout << x <<endl;
    ...
    bool something = (inimg == outputimg);
    cout << boolalpha << something << endl;
    PNG other = inimg;
    something = (inimg == other);
    cout << boolalpha << something << endl;
...
void TestCarveMode0() {
  ...
  if (inimg.height() == 6 && inimg.width() == 5) {
    ...
    cout << "Rendering carved image using rendermode 1 and fillmode 0... "<<endl;
    PNG outputimg2 = list5x6.Render(true, 0); // still carved
    cout << "done." << endl;
    ...
    PNG outputimg3 = list5x6.Render(true, 1); //the width will be bigger than expected
    // you will reach pointers you don't have access to  
    cout << "done." << endl;
